...
//go:embed "schema/common.graphql" "schema/user.graphql"
...
func (ec *executionContext) field_UserOps_create_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCreateUserInput2golangᚑboilerplateᚋinternalᚋmodelᚐCreateUserInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_user(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNUserQueries2ᚖgolangᚑboilerplateᚋinternalᚋmodelᚐUserQueries(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalNCreateUserInput2golangᚑboilerplateᚋinternalᚋmodelᚐCreateUserInput(ctx context.Context, v interface{}) (model.CreateUserInput, error) {
...
func (ec *executionContext) marshalNUserQueries2golangᚑboilerplateᚋinternalᚋmodelᚐUserQueries(ctx context.Context, sel ast.SelectionSet, v model.UserQueries) graphql.Marshaler {
	return ec._UserQueries(ctx, sel, &v)
}

func (ec *executionContext) marshalNUserQueries2ᚖgolangᚑboilerplateᚋinternalᚋmodelᚐUserQueries(ctx context.Context, sel ast.SelectionSet, v *model.UserQueries) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
